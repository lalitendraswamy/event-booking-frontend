...
const EventManagement: React.FC = () => {
    ...
    const filteredEvents = events.filter((event: any) =>
        event.eventName.toLowerCase().includes(searchTerm.toLowerCase()) || event.description.toLowerCase().includes(searchTerm.toLowerCase())
    );
    ...
    // const handleCancelEvent:any = async(index:string) =>{
    //     // await dispatch<any>(deleteEvent(index));
    //     // toast.error("Event deleted successfully!", {
    //     //     position: "top-right",
    //     //     autoClose: 5000,
                    ...
                    <div>
                        ...
                        <div className="event-management-container h-100">
                            ...
                            <Modal show={showModal} onHide={handleCloseModal} className='confirmation-popup popup-container w-100' centered>
                                ...
                                <Modal.Body className="modal-body-custom" style={{borderRadius:"none"}}>
                                    <div className="modal-overlay p-0">
                                                ...
                                                {({ setFieldValue }) => (
                                                    <Form>
                                                        ...
                                                        <div className='event-input-conatiner'>
                                                            ...
                                                            <Field as="textarea" name="description" className="event-input-add" />
                                                            <ErrorMessage name="description" component="div" className="error" />
                                                        </div>
                                                        <div className='event-input-conatiner'>
                                                            <label>Event Date & Time</label>
                                                            <Field type="datetime-local" name="eventDateTime" min={new Date().toISOString().slice(0, 16)} className="event-input-add" />
                                                        ...
                                                        <div className='event-input-conatiner'>
                                                            ...
                                                            <Field type="number" name="totalTickets" className="event-input-add"/>
                                                        ...
                                                        <div className='event-input-conatiner'>
                                                            ...
                                                            <Field name="organizerName" className="event-input-add"/>
                                                            <ErrorMessage name="organizerName" component="div" className="error" />
                                                        </div>
                                                        <div className='event-input-conatiner'>
                                                            <label>Organizer Image</label>
                                                            <Field name="organizerImage" className="event-input-add"/>
                                        ...
                                        <ErrorMessage name="organizerImage" component="div" className="error" />
                                                        ...
                                                        <div className='event-input-conatiner'>
                                                            ...
                                                            <Field type="number" name="ticketPrice" className="event-input-add" />
                                                        ...
                                                        {showPopup && (
                                                            <div style={overlayStyle}>
                                                                <div style={popupStyle}>
                                                                    ...
                                                                    <button className='btn btn-primary' onClick={() => handleDelete(event.eventId)}>Yes</button>
                                                                    <button className='btn btn-primary' onClick={() => setShowPopup(false)}>No</button>
                                                                </div>
                                                            </div>
                                                        )}
                                                        {/* <button
                        ...
                        <Button variant="secondary" onClick={handleCloseModal}>
                          ...
                          <Button className="btn-custom-confirm" onClick={handleCancelEvent(event.eventId)}>
                            Confirm
                                    ...
                                    {true && (<div className="pagination-controls d-flex justify-content-center">
        <button
          className=""
